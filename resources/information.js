const source = `Allt började när jag stod på en stege ett par meter upp i luften och målade en gavel på mina föräldrars sommarstuga. Som från ingenstans dök en fras upp som satt sig från en predikan någon gång.
