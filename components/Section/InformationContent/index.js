...
export const Excerpt = () => {
  ...
  const ReadMoreLink = (<Link href="/information"><a className={styles.readMoreLink}>Läs mer</a></Link>);

  return (<ReactMarkdown source={exc} childAfter={ReadMoreLink} skipHtml />);
};
