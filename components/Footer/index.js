...
export default () => (
  <footer {...styles.footer}>
    ...
    <span><span {...styles.hideTablet}><Italic>18.30 i</Italic></span> <Uppercase>Betlehemskyrkan</Uppercase></span>
  </footer>
);
...
const styles = {
  ...
  footerSvgContainer: merge(
    { width: '100%', padding: '1rem 5rem', display: 'none' },
    media(mediaQuery.tablet, { width: '10%', padding: 0, margin: '0 2rem', display: 'block' }),
    media(mediaQuery.desktop, { width: '3%' }),
  ),

  hideTablet: merge(
    media(mediaQuery.tablet, { display: 'none' }),
  ),
};
